...
const themes = {
  default: {
    ...
    desktop: {
      ...
      bgGradient: '',
      bgOverlay: 'none',
      text: 'Вы в центре заботы Суши Мастер!\nМы внимательно читаем каждый отзыв, чтобы стать лучше. Пожалуйста, поделитесь своими впечатлениями о заказе.' ,
  ...
  'sushi_gallery': {
    ...
    desktop: {
      ...
      bgOverlay: 'none',
      text: 'Ваше удовольствие – главная цель Галереи Суши!\nМы внимательно читаем каждый отзыв, чтобы стать лучше для вас. Пожалуйста, поделитесь своими впечатлениями о заказе.' ,
      textFinish: 'Оставьте отзыв\nо нашей работе' 
    },
    hero: {
      imageWidth: '383px',
  ...
  'mir_sushi': {
    ...
    desktop: {
      ...
      bgGradient: '',
      bgOverlay: 'none',
      text: 'Ваш комфорт – приоритет экипажа Мир Суши!\nМы внимательно изучаем каждый отзыв, чтобы сделать наш сервис идеальным. Пожалуйста, поделитесь впечатлениями о вашем заказе.' ,
      textFinish: 'Оставьте отзыв\nо нашей работе ' 
    },
    hero: {
